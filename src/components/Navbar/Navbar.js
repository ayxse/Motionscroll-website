...
function Navbar() {
  ...
  return (
    <nav className="w-full max-w-4xl relative"> {/* Added relative positioning */}
      ...
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-gray-900/95 backdrop-blur-sm shadow-lg rounded-b-md z-20"> {/* Show only on small screens when open */}
