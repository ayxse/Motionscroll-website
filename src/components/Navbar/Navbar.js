    ...
    <nav className="select-none">
      ...
      <div className="md:hidden">
        <ul className="flex items-center space-x-2">
          <li><Link to="/download" className="text-gray-400 hover:text-white text-sm font-inter font-medium transition-colors duration-200 px-1">Download</Link></li>
          <li><Link to="/guide" className="text-gray-400 hover:text-white text-sm font-inter font-medium transition-colors duration-200 px-1">Guide</Link></li>
          <li><Link to="/about" className="text-gray-400 hover:text-white text-sm font-inter font-medium transition-colors duration-200 px-1">About</Link></li>
        </ul>
      </div>
    </nav>
  );
