  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-16 px-4"> 
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-inter font-bold mb-4 text-white">
          About MotionScroll
        </h1>
        <p className="text-base text-gray-400 font-inter max-w-2xl mx-auto">
      ...
      <div className="bg-gray-900/40 border border-gray-800/50 p-8 rounded-2xl backdrop-blur-sm">
        <div className="flex items-center justify-center mb-6">
          ...
          <h2 className="text-xl md:text-2xl font-inter font-semibold text-white">Open Source Project</h2>
        </div>
        <p className="text-base text-gray-400 font-inter mb-5 text-center leading-relaxed">
