  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-12 px-4 text-gray-100"> {/* Lighter base text, increased max-width */}
      ...
      <div className="grid md:grid-cols-2 gap-10 mb-12">
        ...
        <div className="bg-gray-950/90 border border-gray-600/50 p-8 rounded-xl shadow-lg shadow-black/30 text-center flex flex-col items-center">
          <h3 className="text-2xl font-semibold mb-3 text-white">Android App</h3> {/* White heading */}
          <p className="text-white mb-6">Compatible with Android 8.0 and higher</p> {/* Medium gray text */}
          <button 
      ...
      <div className="text-center bg-gray-950/90 border border-gray-600/50 p-8 rounded-xl shadow-lg shadow-black/30">
