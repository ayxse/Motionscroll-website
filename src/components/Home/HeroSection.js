...
function HeroSection() {
  ...
  return (
    <section className="pt-12 pb-16 px-4 text-center">
      ...
      {/* Download button prominently placed with backdrop fade */}
      <div className="mb-16 relative">
        {/* Fade backdrop behind button */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-32 rounded-2xl blur-xl" 
             style={{
               background: 'radial-gradient(ellipse, rgba(255, 255, 255, 0.12) 0%, rgba(255, 255, 255, 0.06) 50%, transparent 80%)'
             }}>
        </div>
        ...
        <div className="relative z-10">
          <a 
            ...
            className="inline-flex items-center px-6 py-3 bg-white text-black font-inter font-semibold text-base rounded-lg hover:bg-gray-100 transition-all duration-200 shadow-lg shadow-white/10 hover:shadow-white/20"
          >
