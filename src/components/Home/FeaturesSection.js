    ...
    <section className="pt-4 px-1 text-center mb-5"> 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto"> 
        ...
        >
          ...
          <p className="text-gray-300">Perfect for reading long articles, documents, and digital content. The app automatically adjusts scroll speed based on your reading position and pace.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-300">Advanced face-tracking technology provides smooth, responsive scrolling that feels natural and intuitive. No more manual scrolling or interruptions.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-300">All face-tracking processing happens locally on your device. Your camera data never leaves your phone, ensuring your privacy and security.</p>
        </div>
      </div>
    </section>
  );
